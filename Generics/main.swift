...
func findBiggestValue<T:Comparable>(_ a:[T]) -> T{
...
print(findBiggestValue([1212,3234,56567,6]))
...
func combinateArrays<T>(a: [T], b: [T]) -> [T]{
    let total = a + b
    return total
}
print(combinateArrays(a: [32323,4545,454,5,454], b: [3434,34,3434,34]))
